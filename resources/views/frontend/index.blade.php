...
<div class="home-banner-area mb-4 pt-3">
    <div class="container">
        <div class="row gutters-10 position-relative">
            ...
            $featured_categories =
            \App\Category::with('category_translations','products','categories','childrenCategories','parentCategory')->where('featured',
            1)->get();
            @endphp
                ...
                <div class="bg-white rounded shadow-sm">
                    ...
                    <div class="c-scrollbar-light overflow-auto h-lg-400px p-2 bg-primary rounded-bottom">
                        <div class="gutters-5 lg-no-gutters row row-cols-2 row-cols-lg-1">
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal',
                            '1'))->get() as $key => $product)
                            @if ($product != null)
                            <div class="col mb-2">
