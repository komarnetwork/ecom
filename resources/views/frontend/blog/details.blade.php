    ...
    <div class="container">
        <div class="mb-4">
            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                data-src="{{ uploaded_asset($blog->photo) }}" alt="{{ $blog->title }}" width="100px" height="100px"
                ...
                <div class="bg-white rounded shadow-sm p-4">
                    <div class="border-bottom">
                        ...
                        <div class="mb-2 opacity-50">
                            ...
                            <i>{{ date('F d, Y', strtotime($blog->created_at)) }}</i>
                        </div>
                        <div class="fs-sm mb-2"><a class="blog-entry-meta-link text-nowrap" href="#comments"
                                data-scroll> <i class="las la-eye"></i>{{ $blog->view_count }} <span
                                    class="blog-entry-meta-divider"></span> <i class="ci-message"></i> 3 </a> </div>
                        @endif
