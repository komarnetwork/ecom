    ...
    <div class="row mt-5">
        ...
        <div class="offset-lg-2 col-lg-4 col-sm-6">
            <div class="form-group">
                <select class="form-control aiz-selectpicker form-control-sm" data-minimum-results-for-search="Infinity"
        ...
        <div class="col-lg-4 col-sm-6">
            <b class="fs-15 text-success">Pesanan Selesai</b>
        </div>
        @else
        <div class="col-lg-4 col-sm-6">
            <div class="form-group">
                <select class="form-control aiz-selectpicker form-control-sm" data-minimum-results-for-search="Infinity"
                    ...
                    @if ($status=='confirmed' || $status=='on_delivery' || $status=='picked_up' ||
                    $status=='on_the_way')
                    @else
                    ...
                    @else
                    <option value="confirmed" @if ($status=='confirmed' ) selected @endif>{{ translate('Confirmed')}}
                    </option>
                    @endif
                    ...
                    <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                <td>
                                    @if ($orderDetail->refund_request != null &&
