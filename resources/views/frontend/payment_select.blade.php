                            ...
                            <div class="row">
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        ...
                                        'offline_payment')->first()->activated)
                                        ...
                                        <div id="manual_payment_info_{{ $method->id }}" class="d-none">
                                            ...
                                            <ul>
                                                ...
                                                <li>{{ translate('Bank Name') }} - <span
                                                        class="font-weight-bold">{{ $info->bank_name }}</span>,
                                                    {{ translate('Account Name') }} - <span class="font-weight-bold">
                                                        {{ $info->account_name }}</span>,
                                                    {{ translate('Account Number') }} - <span class="font-weight-bold">
                                                        {{ $info->account_number}}</span>,
                                                    {{ translate('Routing Number') }} - <span class="font-weight-bold">
                                                        {{ $info->routing_number }}</span></li>
                                                @endforeach
                                            </ul>
                                            @endif
                                        </div>
