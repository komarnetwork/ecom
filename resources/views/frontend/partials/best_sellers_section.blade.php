...
@php
$array = array();
foreach (\App\Seller::with('user')->where('verification_status', 1)->get() as $key => $seller) {
    ...
    <div class="container">
        <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
            ...
            <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="3" data-lg-items="3" data-md-items="2"
                ...
                @if ($count < 20) @php $count ++; $seller=\App\Seller::with('user')->find($key); $total=0; $rating=0;
                    foreach
                            ...
                            <div class="col-4">
                                <a href="{{ route('shop.visit', $seller->user->shop->slug) }}" class="d-block p-3">
                                    <img src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                        ...
                                        alt="{{ $seller->user->shop->name }}" class="img-fluid lazyload">
                                </a>
                            </div>
