...
<table class="table table-bordered aiz-table">
    ...
    <tbody>
        ...
        <tr class="variant">
            <td>
                <label for="validationServer03" class="control-label">{{ $str }}</label>
            </td>
            <td>
                <input id="validationServer03" type="number" lang="en" name="price_{{ $str }}" value="{{ $unit_price }}"
                    min="0" step="0.01" class="form-control @error('price') is invalid @enderror" required>
                @error('price')
