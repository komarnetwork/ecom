...
class AttributeController extends Controller
{
    ...
    {
        $attributes = Attribute::with('attribute_translations', 'attribute_values')->orderBy('created_at', 'desc')->get();
    ...
    {
        $attribute_value = AttributeValue::with('attribute')->findOrFail($id);
